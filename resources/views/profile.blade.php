      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a class="scroll" href="/profile">Profile</a></li>
...
<section  id="team">
  <div style="margin-top: 50px;" class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        <h2>ANGGOTA TEAM<span>WIN</span></h2>
        <div class="line"></div>
      </div>
    </div>
    <div style="margin-top:100px" class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12 team-main-sec wow slideInUp" data-wow-duration="1s" data-wow-delay=".1s">
        <div class="team-sec">
          <div class="team-img"> <img src="images/Team/{{$i->file}}" class="img-responsive" alt="">
            <div class="team-desc">
              <h5>{{$i->nama}}</h5>
              <p>{{$i->role}}</p>
            </div>
...
<section id="testimonials" class="parallex">
  <div class="container">
    ...
    <div class="slider-text">
      ...
      @foreach($team as $i)
        <div class="item">
          <div  class="col-md-10 col-md-offset-1"> <img src="images/Team/{{$i->file}}" style="width: 100px" class="img-circle" alt="">
            <h5>{{$i->quotes}}</h5>
            <h6>{{$i->nama}}</h6>
            <p>{{$i->jobdesc}}</p>
          </div>
